      ...
      schemas: {
        ...
        Submission: {
          ...
          properties: {
            ...
            fechaSubastaEstimada: { type: 'string', format: 'date-time', nullable: true },
        ...
        patch: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              fechaSubastaEstimada: { type: 'string', format: 'date-time', description: 'Fecha y hora estimadas en que se subastaría la pieza' },
