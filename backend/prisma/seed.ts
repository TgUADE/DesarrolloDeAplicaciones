...
async function main() {
  ...
  if (pmCount === 0) {
    await prisma.paymentMethod.createMany({
      data: [
        { personaId: demoId, tipo: 'cuenta_bancaria_nacional', moneda: 'ARS', banco: 'Banco Nación', numeroCuenta: '0110599520000001234567', montoDisponible: 800000, verificado: true, verifiedAt: new Date(Date.now() - DAY), estado: 'aprobada', activo: true },
        { personaId: demoId, tipo: 'cuenta_bancaria_extranjera', moneda: 'USD', banco: 'Citibank', numeroCuenta: 'US12345678901234', swift: 'CITIUS33', montoDisponible: 25000, verificado: true, verifiedAt: new Date(Date.now() - DAY), estado: 'aprobada', activo: true },
        { personaId: demoId, tipo: 'cuenta_bancaria_nacional', moneda: 'ARS', banco: 'Banco Macro', numeroCuenta: '2850590940090418135201', montoDisponible: 350000, verificado: false, estado: 'pendiente', activo: true },
        { personaId: demoId, tipo: 'tarjeta_credito_nacional', moneda: 'ARS', banco: 'Banco Galicia', numeroTarjeta: '4242', titularTarjeta: 'Juan Pérez', vencimiento: '12/28', montoDisponible: 500000, verificado: false, estado: 'pendiente', activo: true },
        { personaId: demoId, tipo: 'tarjeta_credito_internacional', moneda: 'AMBAS', banco: 'American Express', numeroTarjeta: '1005', titularTarjeta: 'Juan Pérez', vencimiento: '06/29', montoDisponible: 1500000, verificado: true, verifiedAt: new Date(Date.now() - DAY), estado: 'aprobada', activo: true },
        { personaId: demoId, tipo: 'cheque_certificado', moneda: 'ARS', banco: 'Banco Provincia', montoGarantia: 200000, montoDisponible: 200000, verificado: false, estado: 'rechazada', activo: true },
      ],
    });
  }
